...
function CreateTodoElement(item) {
    ...
    const input_el1 = document.createElement("p");
 
	// input_el1.type = "text";
	input_el1.innerText = item.day+" / "+item.month+" / "+item.year+" "+" "+item.hr+"hr : "+item.min+"min";
    // const timest = document.createElement("label");
    
	// timest.innerText = item.hr;
